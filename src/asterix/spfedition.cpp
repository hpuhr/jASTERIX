...
SPFEdition::SPFEdition(const std::string& number, const nlohmann::json& definition, const std::string& definition_path)
  : number_(number)
{
    ...
    if (!fileExists(edition_definition_path_))
        throw invalid_argument ("SPFEdition "+number_+" file '"+edition_definition_path_+"' not found");
...
std::string SPFEdition::document() const
{
    return document_;
}

std::string SPFEdition::date() const
{
    return date_;
}

std::string SPFEdition::file() const
{
    return file_;
}

std::shared_ptr<SpecialPurposeField> SPFEdition::specialPurposeField() const
{
    return spf_;
}

std::string SPFEdition::definitionPath() const
{
    return edition_definition_path_;
}

std::string SPFEdition::number() const
{
    return number_;
}
