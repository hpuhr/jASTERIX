...
//    }
    ...
    REQUIRE (record.at("250").at("Mode S MB Data")[0].at("MB Data")
            == "10000000a00000");
    ...
    REQUIRE (record.at("250").at("Mode S MB Data")[1].at("MB Data")
            == "00000000000000");
    ...
    REQUIRE (approximatelyEqual(ref_pa.at("SDW").at("COV-WGS (Lat/Long Covariance Component)"), -0.000338, 10e-6));
}
