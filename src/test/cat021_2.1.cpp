...
void test_cat021_callback (nlohmann::json& json_data, size_t num_frames, size_t num_records)
{
    ...
    assert (json_data["data_block"]["category"] == 21);
    assert (json_data["data_block"]["length"] == 49);
...
//    }
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("FSPEC").size() == 5*8);
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("010").at("SIC") == 3);
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("ATP") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("ARC") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("RC") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("RAB") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("FX") == 1);

    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("GBS") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("SIM") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("TST") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("SAA") == 1);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("CL") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("040").at("FX2") == 0);

    //    ;  I021/161: =0x 05 5f
    //    ;  Track Number: tn=1375

    loginf << "cat021 test: 161" << logendl;
    assert (json_data.at("data_block").at("content").at("records")[0].at("161").at("Track Number") == 1375);

    //    ;  I021/015: =0x 00
    //    ;  Service Identification: 0

    loginf << "cat021 test: 015" << logendl;
    assert (json_data.at("data_block").at("content").at("records")[0].at("015").at("Service Identification") == 0);
    ...
    double tmp_d = json_data.at("data_block").at("content").at("records")[0].at("130").at("Latitude");
    assert (fabs(tmp_d-46.8442011111) < 10e-4);
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("130").at("Longitude");
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("080").at("Target Address") == 1723237);
    ...
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("073").at("Time of Message Reception for Position");
    ...
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("075").at("Time of Message Reception of Velocity");
    ...
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("140").at("Geometric Height");
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("090").at("NUCr or NACv") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("090").at("NUCp or NIC") == 7);

    //    ;  I021/210: =0x 02
    //    ;  MOPS Version: vns=0; vn=0 (DO-260); ltt=2 (1090 ES)

    loginf << "cat021 test: 210" << logendl;
    assert (json_data.at("data_block").at("content").at("records")[0].at("210").at("VNS") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("210").at("VN") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("210").at("LTT") == 2);

    //    ;  I021/070: =0x 0e 46
    //    ;  Mode 3/A Code: 07106

    loginf << "cat021 test: 070" << logendl;
    assert (json_data.at("data_block").at("content").at("records")[0].at("070").at("Mode-3/A") == 7106);

    //    ;  I021/145: =0x 05 78
    //    ;  Flight Level: 1400 (350.00 FL)

    loginf << "cat021 test: 145" << logendl;
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("145").at("Flight Level");
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("200").at("ICF") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("200").at("LNAV") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("200").at("PS") == 0);
    assert (json_data.at("data_block").at("content").at("records")[0].at("200").at("SS") == 0);

    //    ;  I021/077: =0x 41 6f 91
    //    ;  Time of ASTERIX Report Transmission: 0x416f91 (4288401; 09:18:23.133 UTC)

    loginf << "cat021 test: 077" << logendl;
    tmp_d = json_data.at("data_block").at("content").at("records")[0].at("077").at("Time Of ASTERIX Report Transmission");
    ...
    assert (json_data.at("data_block").at("content").at("records")[0].at("170").at("Target Identification") == "EZS14ZH ");

    //    ;  I021/016: =0x 04
    //    ;  Service Management: rp=4 (2.0 sec)

    loginf << "cat021 test: 016" << logendl;
    assert (json_data.at("data_block").at("content").at("records")[0].at("016").at("RP") == 2.0);
}
...
void test_cat021 (jASTERIX::jASTERIX& jasterix)
{
    ...
    assert (jasterix.hasCategory("021"));
    assert (jasterix.hasEdition("021", "2.1"));
    jasterix.setEdition("021", "2.1");
    jasterix.setMapping("021", "");
