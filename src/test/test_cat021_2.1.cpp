...
//    }
    ...
    REQUIRE (approximatelyEqual(record.at("130").at("Latitude"), 46.8442011111, 10e-4));
    REQUIRE (approximatelyEqual(record.at("130").at("Longitude"), 12.2985291667, 10e-4));
    ...
    REQUIRE (approximatelyEqual(record.at("073").at("Time of Message Reception for Position"), 33502.8828125, 10e-6));
    ...
    REQUIRE (approximatelyEqual(record.at("075").at("Time of Message Reception of Velocity"), 33502.46875, 10e-6));
    ...
    REQUIRE (approximatelyEqual(record.at("077").at("Time Of ASTERIX Report Transmission"), 33503.1328125, 10e-6));
